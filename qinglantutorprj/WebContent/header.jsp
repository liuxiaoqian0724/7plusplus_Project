...
<body>
	<div id="header-box">
        ...
        <div id="login"  class="popup">
          ...
          <form id="login_form" onsubmit="return logincheck()">
            ...
            <div class="input-control has-icon-left" style="width:361px">
              <input id="login_useremail" type="text" class="form-control" placeholder="邮箱" name="login_useremail">
              <label for="inputAccountExample1" class="input-control-icon-left"><i class="icon icon-user "></i></label>
            </div>
            <h5></h5>
            <!--密码-->
            <div class="input-control has-icon-right" style="width:361px">
              <input id="login_password" type="password" class="form-control" placeholder="密码" name="login_password">
            ...
            <button class="btn" type="button" style="margin-left:200px">免费注册</button>
            <h5></h5>
            <button class="btn btn-block" type="submit" style="width:361px" id="loginnow">立即登录</button>
            <span id="show" style="color:red;"></span>
          </form>
          <!--二维码-->
          <div id="login_qrcode">
            <button class="btn btn-block " type="button">免费注册</button>
        ...
        <!--注册register-->
        <div class="panel" id="register"  class="popup">
              ...
              <form class="form-horizontal" onsubmit="return checkRegist()">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                      ...
                      <button class="btn" type="button" style="float:right; margin-top:-32px;">发送验证码</button>
                  </div>
                </div>
                <!--图形验证-->
                <div class="form-group">
                ...
                <div id="role">
                  ...
                  <label class="radio-inline">
                    <input type="radio" name="radioOptionsExample"> 家长
                </label>
                <label class="radio-inline" style="margin-left: 100px;">
                    <input type="radio" name="radioOptionsExample" checked="checked"> 老师
                </label>
                </div>
                <!--协议-->
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-default " style="width: 58%;">注册</button>
                  </div>
                </div>
            </form>
            </div>
