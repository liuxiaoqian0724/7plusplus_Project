...
<div id="login" style="display: none;" class="popup">
	...
	<form id="login_form" onsubmit="return logincheck()" method="post"
		action="user/login">
		<!--邮箱-->
		...
		<h5></h5>
		<button class="btn btn-info" type="submit" style="width: 361px"
			id="loginnow">立即登录</button>
		<br />
		<span id="show" style="color: red;">${errorMsg}</span>
	</form>
	<!--二维码-->
	<div id="login_qrcode">
		...
		<form class="form-horizontal" onsubmit="return checkRegist()"
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="username"
						placeholder="请输入1-6位的汉字、英文、数字、下划线" onblur="checkName()"> <span
						id="nameError" style="color: red; font-size: 17px;"> </span>
				</div>
			</div>
			<!--性别-->
			<div id="sex">
				<label for="exampleInputAccount4" class="col-sm-2">性别</label> <label
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					...
					<span id="pwdError" style="color: red; font-size: 17px;"> </span>
				</div>
			</div>
			<!--确认密码-->
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="password" class="form-control" id="repassword"
						...
						id="rePwdError" style="color: red; font-size: 17px;"> </span>
				</div>
			</div>
			<!--邮箱-->
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="EIdentify"
						...
						id="EIdentifyError" style="color: red; font-size: 17px;"> </span>
				</div>
			</div>
			<!--角色-->
			<div id="role">
			...
			<span id="allError"
				style="color: red; margin-left: 220px; font-size: 18px;"></span>
			<!--注册按钮-->
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<input onclick="submitData()" type="button" value="提交"
						class="btn btn-info" style="width: 58%;">
				</div>
			</div>
		</form>
	</div>
