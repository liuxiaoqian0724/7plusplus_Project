...
<body>
	<div id="header-box">
    		<div id="big-box">
    			...
    			<div class="input-group">
  				...
  				<span class="input-group-btn">
    				<button class="btn btn-primary" type="button" style="background-color:#12b6af;border-color: #12b6af;">搜索</button>
  				</span>
			</div>
    				<!-- 登录注册 -->
    				<div id="header-login">
        ...
        <div id="login"  class="popup">
          ...
          <!--二维码-->
          <div id="login_qrcode">
            <button class="btn btn-info" type="button" style="width: 180px;height: 30px;">免费注册</button>
            <img src="images/qrcode.jpg" style="height:50%;">
            <p>扫描二维码获得更多动态信息</p>
          </div>
        </div>
        ...
        <div class="panel" id="register"  class="popup">
          ...
          <div id="closeframe">
            ...
            <div class="panel-body">
              <form class="form-horizontal" onsubmit="return checkRegist()">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-info" style="width: 58%;">注册</button>
                  </div>
                </div>
            </form>
            </div>
          ...
          <button class="btn btn-info" type="button" style="width: 180px;height: 30px;">免费注册</button>
          <img src="images/qrcode.jpg" style="height:25%;">
          <p>扫描二维码获得更多动态信息</p>
        </div>
      </div>
