					...
					<div id="articlelist">
						<div class="articlecard">
							...
							<div class="author">
								...
								<div class="pull-right" style="position:relative; margin-top:-3%; right:2%;"><i class="icon-comment-alt"></i>
									19</div>
								<div class="pull-right" style="position:relative; margin-top:-3%; right:6%;"><i class="icon-thumbs-o-up"></i>
									19</div>
								<div class="pull-right" style="position:relative; margin-top:-3%; right:10%;"><i class="icon-star-empty"></i>
									19</div>
							</div>
						</div>
						<div class="articlecard">
