		...
		success : function(data) {
			...
			$.each(data,function(index, res) {
				...
				if(index<4){
					...
					'<a class="card" href="###" style="position:relative; width:93%; margin-left:1%;">'+
					'<img src="images/img2.jpg" alt="">'+
					'<div class="card-heading"><strong>'+res.title+'</strong></div>'+
					'<div class="pull-right"><i class="icon-thumbs-o-up"></i>'+res.likeCount+'</div>'+
					'</a>'+
					'</div>';
				...
				if (index >= (currentpage4 - 1) * 5
					...
					articlelist2='<div class="articlecard">'+
						...
						'<div class="card-heading" style="position: relative; margin-top:-11%; left:20%; width:80%;"><strong>'+res.title+'</strong></div>'+
						'<div class="card-content text-muted" style="position: relative; left:20%; width:75%;">'+res.content+
						'</div>'+
						'<div class="author">'+
