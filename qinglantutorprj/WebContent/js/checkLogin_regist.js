...
function checkName(){
		...
		if(username == ""){
			...
			nameError.html('<label class="input-control-icon-right"style=" position:relative; left:-4%;"><img alt="" src="images/icon/error.png" style="width:20px; height:20px;"></label><lable class="ui red message" style="display:inline; height:auto; width:auto; font-size:12px; padding:5px;">用户名必须为6-12位字母和数字的组合</lable>')
		}else{
