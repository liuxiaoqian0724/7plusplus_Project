...
! function(o) {
	o.fn.proschool = function() {
		function i() {
			c += "<div id='m-proschool-layer'></div>", c += "<div id='m-proschool'>", c += " <div class='title'><span>选择学校:</span><span id='close'>×</span></div>", c += " <div class='province'><select>";
			for(var i = 0, l = province.length; l > i; i++) c += "<option value='" + province[i][0] + "'>" + province[i][1] + "</option>";
			c += "</select></div>", c += " <div class='schools'><ul></ul></div>", c += "</div>", o("body").append(c);
			var s = o(document).height(),
				h = o(window).height();
			o("#m-proschool-layer").height(s >= h ? s : h)
		}

		function l(i) {
			for(var c, h = new String(proSchool[i]).split(","), n = "", r = 0, e = h.length; e > r; r++) c = h[r], n += c.length > 13 ? "<li class='DoubleWidthLi'>" + h[r] + "</li>" : "<li>" + h[r] + "</li>";
			o("div#m-proschool ul").html(n), o("div#m-proschool select").change(function() {
				l(o(this).val())
			}), o("div#m-proschool ul li").on("click", function() {
				s.val(o(this).html()), o("div#m-proschool").hide(), o("div#m-proschool-layer").hide()
			})
		}
		var c = "",
			s = this;
		return this.attr("readonly", "readonly"), this.focus(function() {
			"" === c && (i(), o("div#m-proschool #close").on("click", function() {
				o("div#m-proschool").hide(), o("div#m-proschool-layer").hide()
			}));
			var s = o("div#m-proschool select").val();
			l(s), o("#m-proschool").show(), o("div#m-proschool-layer").show()
		})
	}
}(jQuery);