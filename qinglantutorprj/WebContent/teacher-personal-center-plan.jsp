...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dist/lib/kindeditor/kindeditor.css" />
	<link rel="stylesheet" type="text/css" href="dist/lib/kindeditor/kindeditor.min.css" />
	<!-- jQuery (ZUI中的Javascript组件依赖于jQuery) -->
	<!-- ZUI Javascript组件 -->
	<script src="dist/lib/kindeditor/kindeditor.min.js"></script>
	<script src="dist/lib/kindeditor/kindeditor.js"></script>
	<script src="dist/lib/kindeditor/plugins/ok.js"></script>	
        ...
        <div class="panel-body">
          <div>
              <div class="c2-right-img">
                <img src="images/b.jpg" width="100px" height="100px" class="img-circle" alt="圆形图片">
                <p>张三</p>
              </div>
                  ...
                  <div>
                      <div class="c2-right-item">
                        <div>
                            ...
                            <a href="javascript:void(0)" onclick = "setContent('zhangsan-1')"><span class="icon icon-edit"></span></a>
                            <div id="zhangsan-1">111</div>
                      ...
                      <div class="c2-right-item">
                        <div>
                            <a href="#"><span class="icon icon-times"></span></a>
                            <a href="javascript:void(0)" onclick = "setContent('zhangsan-2')"><span class="icon icon-edit"></span></a>
                            <div id="zhangsan-2"></div>
                            <span>2018-08-10</span>
                        </div>
                      </div>
                      <div class="c2-right-edit">
                        <a href="#"><span class="icon icon-plus icon-2x"></span></a>
                      </div>
                      <button class="zhangsan" onclick="">保存</button>
                  </div>
              </div>
          </div>
        </div>
