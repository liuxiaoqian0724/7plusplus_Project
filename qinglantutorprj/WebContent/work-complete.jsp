	...
	<div id="d1">
		...
		<c:if test="${not empty hid}">
			...
			<c:if test="${not empty ts}">
				<script id="editor" type="text/plain" style="width:760px;height:150px;" name="content"></script>
				<input name="hid" type="hidden" value="${hid}">
				
				<p id="question" >作业疑问</p>
				<textarea style="resize: none;width: 230px;height: 75px;margin-left: 120px;margin-top: 30px;" name="question"  disabled="disabled"></textarea>
