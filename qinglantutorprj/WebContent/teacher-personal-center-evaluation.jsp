...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>/css/personal-center.css">
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>/css/teacher-myevaluation.css">
<link rel="stylesheet" type="text/css"
	...
	<div id="head">
		<div id="header-box">
			<div id="big-box">
				...
				<div id="top-box">
					<div id="top-box-logo">
						<img src="<%=basePath%>/images/headerlogo.png" alt="logo"
							id="logoPic">
						<div id="name-pic">
							<img src="<%=basePath%>/images/nameTop.png" alt="namePic"
								style="width: 263.3px; height: 66px;">
						</div>
					</div>
				</div>
			</div>
	...
	<div id="content">
		<div id="c1">
			<ul>
				<li id="c1-img">
					<div>
						<img src="http://zui.sexy/docs/img/img2.jpg" width="120px"
							height="120px" class="img-circle" alt="圆形图片">
					</div>
					<p>积分：1024</p>
				</li>
				<li id="c1-about">
					<p>狗蛋</p> <span class="label label-badge">认证家教</span> <span
					class="label label-badge">大三</span>
				</li>
				<li id="c1-person">
				...
				<li id="c1-star">
					...
					<div id=c1-star-div>
						<img src="<%=basePath%>/images/fill-star.png"
							style="width: 25px; height: 25px;"> <img
							src="<%=basePath%>/images/fill-star.png"
							style="width: 25px; height: 25px;"> <img
							src="<%=basePath%>/images/fill-star.png"
							style="width: 25px; height: 25px;"> <img
							src="<%=basePath%>/images/fill-star.png"
							style="width: 25px; height: 25px;"> <img
							src="<%=basePath%>/images/empty-star.png"
		...
		<div id="c2">
			<div class="c2" id="c2-left">
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-envelope"></i>&nbsp;我的消息<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-book"></i>&nbsp;我的课程<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-flag"></i>&nbsp;学员评价<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-newspaper-o"></i>&nbsp;我的文章<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-question-sign"></i>&nbsp;我的问答<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-wrench"></i>&nbsp;个人资料<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-stack"></i>&nbsp;我的教案<i
						class="icon icon-chevron-right"></i></a>
				</div>
				<div class="c2-left-item" id="c2-left-news">
					<a href="#"><i class="icon icon-file-text-o"></i>&nbsp;我的作业<i
						class="icon icon-chevron-right"></i></a>
				</div>
			</div>
				...
				<div class="panel-body">
					<div>
						<div class="c2-right-left">
							<img src="<%=basePath%>/images/b.jpg" width="125px"
								height="125px" class="img-circle" alt="圆形图片">
							<p>匿名用户</p>
						</div>
	...
	<div class="footer">
		...
		<div class="footer-font">
			...
			<div id="footer-font-a">
				...
				<div id="a-font">
					<a href="#" class="footer-words">加入我们</a> <a href="#"
						class="footer-words">网站须知</a> <a href="#" class="footer-words">意见反馈</a>
			...
			<div id="footer-font-friend">
				...
				<div id="friend-logo">
					<div id="friend-logo-div1">
						<i class="icon icon-github icon-3x"></i> <i
							class="icon icon-qq icon-3x"></i> <i
							class="icon icon-wechat icon-3x"></i>
					</div>
				</div>
			</div>
		...
		<div id="footer-right">
			<div id="footer-right-font">
				<p>
					<br> <a href="#" id="footer-right-font-a1">Copyright
						2018-2020&nbsp;&nbsp;&nbsp;青蓝家教</a> <a href="#"
						id="footer-right-font-a1">Copyright
						2018-2020&nbsp;&nbsp;&nbsp;青蓝家教</a> <a href="#"
						id="footer-right-font-a2">冀ICP备05067795号 冀公网安备110402440008号 </a>
				</p>
			</div>
		</div>
	</div>
