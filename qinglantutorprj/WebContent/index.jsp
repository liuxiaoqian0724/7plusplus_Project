...
<body>
	...
	<div class="container-fixed">
		...
		<div class="tutor_information_pic">
			<img src="<%=basePath%>/images/hr.png"
				style="position: relative; width: 408px; margin-left: 0px; margin-top: 50px; display: inline;" />
			<img src="<%=basePath%>/images/tutorinf.png"
				style="position: relative; margin-top: 25px; margin-left: 50px;" />
			<img src="<%=basePath%>/images/hr.png"
				style="position: relative; width: 408px; margin-left: 730px; margin-top: -70px;" />
		</div>
		...
		<div class="tutor_information">
			...
			<div class="btn-group" id="choose_button">
				...
				<button class="btn btn-info" type="button" id="i_wonder_release"
					onclick="window.location.href='<%=basePath%>/sendmessageed.jsp'">
					<i class="icon icon-pencil"></i>我要发布
				</button>
			</div>
			...
			<div class="cards cards-borderless" id="personal_information"
				...
				<ul class="pager" id="pager"
					style="float: right; position: relative; margin-right: 45%;">
		...
		<div class="studycommunity">
			<img src="<%=basePath%>/images/hr.png"
				style="position: relative; width: 408px; margin-left: 0px; margin-top: 50px; display: inline;" />
			<img src="<%=basePath%>/images/studycommunity.png"
				style="position: relative; margin-top: 25px; margin-left: 50px;" />
			<img src="<%=basePath%>/images/hr.png"
				style="position: relative; width: 408px; margin-left: 730px; margin-top: -70px;" />
		</div>
		...
		<div id="learning_community" class="panel">
			<!--按钮choose_button-->
			<div class="btn-group" id="choose_button">
				<button type="button" class="btn btn-info" id="opt1"
					onclick="learning_experienceDis()">学习经验</button>
				<button type="button" class="btn btn-info" id="opt2"
					onclick="course_questionDis()">课程问答</button>
				<button type="button" class="btn btn-info" id="opt3"
					onclick="community_authorDis()">社区作者</button>
				<button class="btn btn-info" type="button" id="i_wonder_release"
					onclick="window.location.href='sendmessage.jsp'">
					<i class="icon icon-pencil"></i>我要发布
				</button>
			</div>
			<!--学习经验-->
					...
					<div class="item">
						...
						<div class="card_keyword">
							<div class="btn-group btn-group-vertical"
								style="width: 150px; position: relative; margin-left: 15px;">
							...
							<h3></h3>
							<div class="btn-group">
								<button type="button" class="btn" id="collection"
									onclick="changstars()">
									<i class="icon icon-star-empty"></i><span id="collectioncount">108</span>
								</button>
								<button type="button" class="btn" id="good"
									onclick="changegood()">
									<i class="icon icon-thumbs-o-up"></i><span id="goodcount">108</span>
								</button>
								<button type="button" class="btn">
									<i class="icon icon-chat-line"></i>108
								</button>
							</div>
						</div>
						<!--文章及图片-->
						<div class="cards_article">
							<div class="item-heading">
								...
								<h4>
									<a href="###">巧解物理难题——中考冲刺经验分享</a>
								</h4>
							</div>
							<div class="item-content">
								<div class="media pull-right">
									<img src="<%=basePath%>/images/physics.jpg" alt=""
										style="height: 75%; width: 75%; margin-top: -20px; margin-left: 15px;">
								</div>
							...
							<div class="item-footer">
								<a href="#" class="text-muted"><span class="text-muted">2013-11-11
										16:14:37</span>
							</div>
						</div>
					</div>
				...
				<div class="items items-hover" id="card">
					<div class="item">
						...
						<div class="card_keyword">
							...
							<div class="btn-group">
								<button type="button" class="btn">
									<i class="icon icon-star-empty"></i>108
								</button>
								<button type="button" class="btn">
									<i class="icon icon-thumbs-o-up"></i>108
								</button>
								<button type="button" class="btn">
									<i class="icon icon-chat-line"></i>108
								</button>
						...
						<div class="cards_article">
							<div class="item-heading">
								<div class="pull-right label label-success"></div>
								<h4>
									<a href="###">学霸传授——高考数学偷分技巧</a>
								</h4>
							</div>
							<div class="item-content">
								<div class="media pull-right">
									<img src="<%=basePath%>/images/maths.jpg" alt=""
										style="height: 75%; width: 75%; margin-top: -20px; margin-left: 15px;">
								</div>
					...
					<div class="item">
						...
						<div class="cards_article">
							<div class="item-heading">
								<div class="pull-right label label-success"></div>
								<h4>
									<a href="###">中考英语完形填空三大技巧分享</a>
								</h4>
							</div>
							<div class="item-content">
								<div class="media pull-right">
									<img src="<%=basePath%>/images/english.jpg" alt=""
										style="height: 75%; width: 75%; margin-top: -20px; margin-left: 15px;">
								</div>
								<div class="text">完形填空题以其内容广泛和知识、能力有机结合而备受命题者的青睐，它也是各类英语测试和竞赛中的重点题。且多数同学认为完形填空题是较难的题型
									之一。金华龙文教育个性化辅导教师认为，完形填空题难主要有两个原因：一是它所测试的内容几乎是无所不包：单词……</div>
							</div>
							<div class="item-footer">
								<a href="#" class="text-muted"><span class="text-muted">2013-11-11
										16:14:37</span>
			...
			<div id="course_question" style="display: none;">
					...
					<div class="items items-hover" id="qanda">
						<div class="item">
							...
							<div class="item-footer">
								...
								&nbsp;&nbsp;&nbsp; <span class="text-muted">回答者：<a
									href="#">刘强</a></span>&nbsp;&nbsp;&nbsp; <span class="text-muted"><a
									href="#"><i class="icon icon-thumbs-o-up"></i>108</a></span>
							</div>
						</div>
					</div>
					<div class="items items-hover" id="qanda">
				...
				<div class="panel" id="goodresponder">
					<div class="panel-body">
						<h3>优秀回答者</h3>
						<a href="#"><img src="<%=basePath%>/images/idphotocircle1.png"
							style="position: relative; margin-left: 10px;"></a> <a href="#"
							style="position: relative; margin-left: 36px;"><img
							src="<%=basePath%>/images/idphotocircle2.png"></a>
						<p></p>
						<a href="#"><img src="<%=basePath%>/images/idphotocircle3.png"
							style="position: relative; margin-left: 10px;"></a> <a href="#"
							style="position: relative; margin-left: 36px;"><img
							src="<%=basePath%>/images/idphotocircle1.png"></a>
						<p></p>
						<a href="#"><img src="<%=basePath%>/images/idphotocircle2.png"
							style="position: relative; margin-left: 10px;"></a> <a href="#"
							style="position: relative; margin-left: 36px;"><img
							src="<%=basePath%>/images/idphotocircle3.png"></a>
						<p></p>
						<a href="#"><img src="<%=basePath%>/images/idphotocircle3.png"
							style="position: relative; margin-left: 10px;"></a> <a href="#"
							style="position: relative; margin-left: 36px;"><img
			...
			<div id="community_author" style="display: none;">
				<div class="items items-hover" id="author">
					<div class="item">
						<a href="#"><img src="<%=basePath%>/images/idphotocircle1.png"
							style="width: 12%; margin-left: 15px;"></a>
						<div class="btn-group btn-group-vertical"
							style="position: relative; margin-left: 25px; width: 80px; margin-top: 10px">
						...
						<div class="personal_introduction">
							<br /> <b>个人介绍：</b>主要是初中英语，数学，小学全科的教程奥语及课内外作业，针对性补差，提高简单题的做题速度和难题的解题思路方法，培养良好的习惯和自学能力。在一教育机构任职，课后进行私人辅导，喜欢小孩有责任心，耐心。希望在这过程中共同成长进步。
						</div>
						<div class="personal_article">
							<h3>
								<b>他的文章</b><br />
							</h3>
							<a href="#"><h4>巧解物理难题——中考冲刺经验分享</h4></a> <a href="#"><h4>巧解物理难题——中考冲刺经验分享</h4></a>
							<a href="#"><h4>巧解物理难题——中考冲刺经验分享</h4></a>
							<button class="btn" type="button"
								style="position: relative; margin-left: 240px; margin-top: -30px;">查看更多</button>
						</div>
						<button class="btn btn-mini " type="button"
							style="position: relative; margin-left: 1010px; margin-top: -260px;">
			...
			<!--分页-->
			<ul class="pager" id="pager" data-ride="pager" data-page="2"
