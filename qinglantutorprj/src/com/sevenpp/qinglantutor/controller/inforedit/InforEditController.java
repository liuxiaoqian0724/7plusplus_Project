...
public class InforEditController {
	...
	@ResponseBody
	public String inforChange(@RequestBody User u,HttpServletRequest request) {
		u.setEmail("zhangsan@qq.com");
		User user = this.inforEditServiceImpl.getUserByEmail("zhangsan@qq.com");
