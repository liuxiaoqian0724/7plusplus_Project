...
/*		response.setHeader("Access-Control-Allow-Origin", "*");
		...
		String UserId=CookieUtils.getCookieFromCookies(cookies, "id").getValue();*/
	 ...
	 */
			...
			public void sendMsgToTutor(@RequestBody Map<String, String>map,HttpServletRequest request,HttpServletResponse response) {
				Integer tutorId=Integer.parseInt(map.get("userId"));
				this.tutorDetailServiceImpl.sendMsgToTutor(tutorId, 11, map.get("gradeChosen"));
