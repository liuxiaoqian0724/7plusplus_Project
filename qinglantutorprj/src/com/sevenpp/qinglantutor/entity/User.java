...
public class User  implements java.io.Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", userName=" + userName + ", userPwd=" + userPwd + ", email=" + email + ", role="
				...
				+ ", stuImg=" + stuImg + ", userImg=" + userImg + ", img1=" + img1 + ", img2=" + img2 + ", img3=" + img3
				+ ", img4=" + img4 + ", school=" + school + ", grade=" + grade + ", phoneNumber=" + phoneNumber
				+ ", address=" + address + ", introduce=" + introduce + ", major=" + major + ", status=" + status
				+ ", publickey=" + publickey + ", privatekey=" + privatekey + ", msgs=" + msgs + ", myJobs=" + myJobs
				+ ", teachRelations=" + teachRelations + ", classRelation=" + classRelation + "]";
	}	
